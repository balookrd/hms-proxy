 ...
 * under the License.
 */
// Vendored verbatim from apache-iceberg-1.5.2 (core/src/test/java/org/apache/iceberg/rest).
// In 1.5.x this class lives in test sources of iceberg-core; the copy here lets the
...
public class RESTCatalogAdapter implements RESTClient {
  ...
  // Patched from upstream: was package-private; promoted to public so callers outside
  // org.apache.iceberg.rest (notably IcebergRestService) can dispatch by method.
  ...
  // Patched from upstream: was package-private; promoted to public so HTTP front-ends
  // outside this package can resolve route and request type for body deserialization.
  public enum Route {
