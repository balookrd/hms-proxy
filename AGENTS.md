...
- **Всегда синхронно обновляй документацию** (`README.md`, `README.ru.md`, `src/main/resources/hms-proxy-example.properties`, `capabilities.yaml`) при изменении runtime-поведения, добавлении новых настроек, конфигурационных ключей или возможностей.
