...
- **Всегда обновлять changelog при коммитах**: любые изменения (новые фичи, фиксы, изменения конфигурации) обязательно синхронно вносить в `CHANGELOG.md` (RU) и `CHANGELOG.en.md` (EN) в секцию `[Unreleased]`.
